# PSB Edu Web Service — MVP онлайн-школы

## О хакатоне

- **Название:** Hack&Change 2025  
- **Организатор:** Changellenge >>
- **Даты:** 28–30 ноября 2025  
- **Диплом участника:** [`changellenge1_web_псб.pdf`](docs/diploma/changellenge1_web_псб.pdf)

## О проекте  

**Полноценный MVP** онлайн-школы, разработанный в рамках хакатона **Hack&Change 2025**.  
...
Проект включает в себя следующие ключевые элементы UI/UX:
